...
with sync_playwright() as p:
 ...
 page.goto(URL+'load-order.html#mod-056');page.wait_for_selector('#mod-056');check('browser load order shows ArteFakes #57','ArteFakes' in page.locator('#mod-056').inner_text());check('browser Artificer #58','Artificer' in page.locator('#mod-057').inner_text())
