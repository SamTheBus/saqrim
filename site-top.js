...
(() => {
 const entries=[['./','Loot catalog · 633'],['load-order.html','Load order · 210'],['map.html','Map'],['quests.html','Quests & rewards'],['shrines.html','Shrines & Gods'],['standing-stones.html','Standing Stones']];
 function activePath(){
